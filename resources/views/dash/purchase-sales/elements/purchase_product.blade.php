                ...
                <form action="{{ route('create-purchase-product') }}" method="POST">
                    ...
                    <div class="row align-items-end">
                        <div class="col-6">
                            ...
                            <input class="form-control" placeholder="Nama Barang" type="string" name="nama_brg" id="nama_brg" required>
                        </div>
                    ...
                    {{-- @if (session()->has('dataSelected')) --}}
                        <div class="row mt-3">
                            ...
                            {{-- <div class="col-md-3">
                                <label for="isi">Isi/Satuan Barang</label>
                                <input required type="number" placeholder="isi/satuan" name="isi" id="isi" class="form-control border border-success">
                            </div> --}}
                            <div class="col-md-3">
                                <label for="bentuk">Bentuk Sediaan</label>
                                <input required type="string" name="bentuk" id="bentuk" placeholder="Bentuk sediaan barang" class="form-control">
                            </div>
                            <div class="col-md-3" id="formZat">
                                <label for="zat">Zat Aktif (Opsional)</label>
                                <input type="string" name="zat" id="zat" placeholder="Zat Aktif" class="form-control">
                            </div>
                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update-purchase-product', $item->purchase_product_id) }}" method="POST">
                                                ...
                                                <div class="row" style="row-gap: 15px;">
                                                    <div class="col-md-6">
                                                        <label for="jumlah">Jumlah ({{ $item->satuan->satuan_barang }})</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="string" name="bentuk" value="{{ $item->bentuk }}" id="bentuk" placeholder="Masukkan bentuk" class="form-control">
                                                    </div>
                                                </div>
                                    ...
                                    <div id="{{ 'delete'.$item->purchase_product_id }}" class="modal">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('delete-purchase-product', $item->purchase_product_id) }}" method="POST">
                                                @csrf
                                                <p>Yakin untuk menghapus item <strong>{{ $item->nama_brg }}</strong></p>
                                                <div class="mt-3">
