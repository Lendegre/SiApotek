...
<body>
    ...
    <h3 style="text-align: center; margin-top: 10px;">LAPORAN PERSEDIAAN BARANG</h3>
    ...
    <table border="1" style="width: 100%" class="border border-dark">
        <thead>
            <tr>
                ...
                <th class="table-cell text-center">Stok</th>
                <th class="table-cell text-center">Jumlah Beli</th>
                <th class="table-cell text-center">Jumlah Jual</th>
                <th class="table-cell text-center">Minimal Stok</th>
                <th class="table-cell text-center">Kedaluwarsa</th>
            </tr>
        </thead>
        <tbody>
            @foreach($barang as $sb)
                <tr style="margin: 10px;">
                    ...
                    <td class="table-cell text-center">{{ $dataBarangmasuk->where('barang_id',$sb->barang_id)->sum('jumlah') }} {{ $sb->satuan->satuan_barang }}</td>
                    <td class="table-cell text-center">{{ $dataOrder->where('barang_id', $sb->barang_id)->sum('stok') }} {{ $sb->satuan_jual }}</td>
                    <td class="table-cell text-center">{{ $sb->minimal_stok }} {{ $sb->satuan_jual }}</td>
                    <td class="table-cell text-center">{{ $sb->tanggal_kedaluwarsa }}</td>
                </tr>
                @endforeach
                {{-- <tr style="margin-top: 10px;">
                    <td class="table-cell text-center"></td>
                    <td class="table-cell text-center"><strong>TOTAL KESELURUHAN</strong></td>
                    <td class="table-cell text-center"></td>
                    <td class="table-cell text-center"></td>
                    <td class="table-cell text-center"></td>
                </tr> --}}
    ...
    <table border="1" style="width: 70%; margin-top:15px;" class="border border-dark">
        <thead>
            <tr>
